...
{!! Form::open(array('route' => config('quickadmin.route').'.adhfrothorax.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('ro_thorax', old('ro_thorax'), array('class'=>'form-control')) !!}
