...
{!! Form::open(array('route' => config('quickadmin.route').'.chronicechocardiography.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('edd', old('edd'), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::text('signMr', old('signMr'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('diastolicFunction', 'Diastolic function*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('diastolicFunction', old('diastolicFunction'), array('class'=>'form-control')) !!}
