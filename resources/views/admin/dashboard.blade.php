...
@section('content')
    ...
    <li style="font-size: 17px; font-family: Calibri, sans-serif;">Some variables will be filled automatically by inputting other basic data. For example :</li>
    <li style="font-size: 17px; font-family: Calibri, sans-serif;">&ldquo;Age&rdquo;: will appear after &ldquo;date of birth&rdquo; and &ldquo;date of admission/date of clinic visit&rdquo; data entry<ul style="list-style-type: disc; font-family: initial; font-style: initial;">
