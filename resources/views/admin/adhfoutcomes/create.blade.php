...
{!! Form::open(array('route' => config('quickadmin.route').'.adhfoutcomes.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('inhospitalDeath', old('inhospitalDeath'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('vulnerablePhaseDeath', 'Vulnerable phase death*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('vulnerablePhaseDeath', old('vulnerablePhaseDeath'), array('class'=>'form-control')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('vulnerablePhaseRehospitalization', 'Vulnerable phase rehospitalization*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('vulnerablePhaseRehospitalization', old('vulnerablePhaseRehospitalization'), array('class'=>'form-control')) !!}
